...
etapes = [
    ...
    ("4 — Calcul de la surface consommée",
     "> **Surface consommée (m²) = linéaire des murs (m) × épaisseur totale (m)**\n\n"
    ...
    ("5 — Calcul du coût initial",
     "> **Coût fourniture = surface des murs × prix fourniture €/m²**\n"
     "> **Coût pose = surface des murs × prix pose €/m²**\n"
     "> **Coût initial = coût fourniture + coût pose**"),
    ("6 — Valorisation de la surface consommée",
     "> **Valorisation économique indicative = surface consommée × prix du logement €/m²**\n\n"
    ...
    ("7 — Calcul du coût global indicatif",
     "> **Coût global indicatif = coût initial + valorisation économique de la surface consommée**\n\n"
     "Cet indicateur permet de comparer des solutions à investissement initial différent en "
     "intégrant le coût d'opportunité de la surface consommée."),
    ("8 — Deux recommandations",
     "Parmi les solutions techniquement admissibles :\n\n"
     "**Meilleur compromis technico-économique** → solution avec le plus faible coût global indicatif. "
     "En cas d'égalité, on préfère la plus mince.\n\n"
     "**Alternative à investissement initial réduit** → solution avec le plus faible coût initial. "
